...
{"Id":5,"Name":"Janice Rose","Username":"KeithHart","Email":"nulla@Linktype.com","Phone":"146-91-01","Password":"acSBF5","Address":"Russell Trail 61"}`
	...
	t.Run("ErrReaderIsNil", func(t *testing.T) {
		result, err := GetDomainStat(nil, "test")
		require.ErrorIs(t, err, ErrReaderIsNil)
		require.Nil(t, result)
	})

	t.Run("ErrDomainIsEmpty", func(t *testing.T) {
...
func BenchmarkGetDomainStat(b *testing.B) {
	for i := 0; i < b.N; i++ {
		...
		b.StartTimer()
		var funcGetDomainStat func(r io.Reader, domain string) (DomainStat, error)

		if isOld {
			funcGetDomainStat = GetDomainStatOld
		} else {
			funcGetDomainStat = GetDomainStat
		}

		stat, err := funcGetDomainStat(data, "biz")
		b.StopTimer()
